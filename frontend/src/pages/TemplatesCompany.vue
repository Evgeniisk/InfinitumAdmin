<template>
    <form>
        <div class="row mb-3">
            ...
            <div class="col-1">
                <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-title="This input field recognises only .docx file formats." data-bs-content="This input field recognises the following placeholders inside the .docx document that are inside the { } brackets: {Company_Name}, {Company_Address}, {Signer_First_Name}, {Signer_Last_Name}, {Directors_Signature}, {Date_Signed_Director}, {Signer_Signature}, {Date_Signed_Signer}, {Total_price}, {Total_Price_with_VAT}, {Payments_Breakdown} and recognises the following placeholders inside the table of the .docx document that are inside the { } brackets: {Service_or_Product_Name}, {Price_with_VAT}, {Price}, {VAT}, {Total_price}, {Total_VAT}, {Total_Price_with_VAT}.">
        ...
        <div class="row mb-3">
            ...
            <div class="col-12">
                ...
                <template v-else>
                    <div v-if="FileInvoiceName" class="mb-1">
                        <strong>Current file:</strong>
                        <p>{{ FileInvoiceName }}</p>
                    </div>
                    <div v-else>
        ...
        <div class="row mb-3">
            ...
            <div class="col-1">
                <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="This field acceps the following placeholders inside the { } brackets: {Company_Name}, {Signer_First_Name}, {Signer_Last_Name}, {Related_Contact_First_Name}, {Related_Contact_Last_Name}, {Related_Contact_Company_Name}. In order for the related contacts placeholders to be replaced, you have to choose them to be used for templates on the client information page. An example of using this is: {Company_Name}'s {Signer_First_Name} you received a contract from Example Ltd. Where {Company_Name} will be replaced with your client's company name, {Signer_First_Name} will be replaced with the signer's name who is linked to this client">
                    <img src="/src/assets/info-circle.svg">
                </span>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-1">
                <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="This field acceps the following placeholders inside the { } brackets: {Company_Name}, {Signer_First_Name}, {Signer_Last_Name}, {Period}, {Related_Contact_First_Name}, {Related_Contact_Last_Name}, {Related_Contact_Company_Name}. In order for the related contacts placeholders to be replaced, you have to choose them to be used for templates on the client information page. An example of using this is: {Company_Name}'s {Related_Contact_First_Name} you received an invoice from Example Ltd for the period of {Period}. Where {Company_Name} will be replaced with your client's company name, {Related_Contact_First_Name} will be replaced with the individual related contract's first name who is chosen to be used for templates on the client information page, and {Period} will be replaced with 'month starting on dd-mm-yyyy' or 'week starting on dd-mm-yyyy' depending on the chosen schedule period of invoices.">
                    <img src="/src/assets/info-circle.svg">
                </span>
            </div>
        </div>
        <div class="row mb-3">
            ...
            <div class="col-1">
                <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="This field acceps the following placeholders inside the { } brackets: {Company_Name}, {Signer_First_Name}, {Signer_Last_Name}, {Period}, {Related_Contact_First_Name}, {Related_Contact_Last_Name}, {Related_Contact_Company_Name}. In order for the related contacts placeholders to be replaced, you have to choose them to be used for templates on the client information page. An example of using this is: {Company_Name}'s {Signer_First_Name} you received an invoice from Example Ltd for the period of {Period}. Where {Company_Name} will be replaced with your client's company name, {Signer_First_Name} will be replaced with the signer's name who is linked to this client, and {Period} will be replaced with 'month starting on dd-mm-yyyy' or 'week starting on dd-mm-yyyy' depending on the chosen schedule period of invoices.">
                    <img src="/src/assets/info-circle.svg">
                </span>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-1">
                <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="This field acceps the following placeholders inside the { } brackets: {Company_Name}, {Signer_First_Name}, {Signer_Last_Name}, {Period}, {Related_Contact_First_Name}, {Related_Contact_Last_Name}, {Related_Contact_Company_Name}. In order for the related contacts placeholders to be replaced, you have to choose them to be used for templates on the client information page. An example of using this is: {Company_Name}'s {Related_Contact_First_Name} you received an invoice from Example Ltd for the period of {Period}. Where {Company_Name} will be replaced with your client's company name, {Signer_First_Name} will be replaced with the signer's name who is linked to this client, and {Period} will be replaced with 'month starting on dd-mm-yyyy' or 'week starting on dd-mm-yyyy' depending on the chosed schedule period of invoices.">
                    <img src="/src/assets/info-circle.svg">
                </span>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-1">
                <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="This field acceps the following placeholders inside the { } brackets: {Company_Name}, {Signer_First_Name}, {Signer_Last_Name}, {Period}, {Related_Contact_First_Name}, {Related_Contact_Last_Name}, {Related_Contact_Company_Name}. In order for the related contacts placeholders to be replaced, you have to choose them to be used for templates on the client information page. An example of using this is: {Company_Name}'s {Signer_First_Name} you received an invoice from Example Ltd for the period of {Period}. Where {Company_Name} will be replaced with your client's company name, {Signer_First_Name} will be replaced with the signer's name who is linked to this client, and {Period} will be replaced with 'month starting on dd-mm-yyyy' or 'week starting on dd-mm-yyyy' depending on the chosed schedule period of invoices.">
                    <img src="/src/assets/info-circle.svg">
                </span>
            </div>
        </div>
